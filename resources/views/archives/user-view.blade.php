...
<body class="bg-gray-50">
    ...
    @section('title', 'Archived Account')
    @section('content')
        <div class="container mx-auto pt-0 px-8 max-w-full">
            ...
            @if (session('success'))
                <div id="success-alert" class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-4 rounded" role="alert">
                    ...
                    <div class="mt-2 text-sm">
                        Redirecting to archived users list in <span id="countdown">3</span> seconds...
                    </div>
                </div>
                ...
                <script>
                    ...
                    const countdownInterval = setInterval(function() {
                        ...
                        if (secondsLeft <= 0) {
                            ...
                            window.location.href = "{{ route('archives.users') }}";
                        }
                    }, 1000);
                </script>
            @endif
            ...
            <div class="flex items-center mb-6">
                <a href="{{ route('archives.users') }}" class="text-gray-600 mr-4">
            ...
            <div class="grid grid-cols-12 gap-10">
                ...
                <div class="col-span-8">
                    <div class="bg-white rounded-lg shadow-sm h-full flex flex-col">
                        <div class="bg-purple-900 text-white px-8 py-6 rounded-t-lg">
                            <h2 class="font-medium text-xl">Archived User Information</h2>
                        </div>
                        <div class="p-8 flex-1 flex flex-col">
                            <!-- Information Tabs -->
                            <div class="border-b border-gray-200">
                                <div class="flex">
                                    <button onclick="showInfo('personal')" id="personalTab" class="px-8 py-4 border-b-2 border-purple-900 font-medium text-purple-900">Personal Information</button>
                                    <button onclick="showInfo('account')" id="accountTab" class="px-8 py-4 text-gray-500">Account Information</button>
                                </div>
                            </div>
                            ...
                            <div class="flex-1 flex flex-col justify-between">
                                ...
                                <div class="mt-8">
                                    ...
                                    <div id="personalInfo" class="space-y-10">
                                    ...
                                    <div id="accountInfo" class="hidden space-y-10">
                                        <div class="grid grid-cols-2 gap-x-16 gap-y-10">
                                            <div>
                                            ...
                                            <div>
                                                <p class="text-gray-500 text-sm">Archived Date</p>
                                                <p class="font-medium">{{ $user->archived_at ? \Carbon\Carbon::parse($user->archived_at)->format('M d, Y h:i A') : 'Not available' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                
                                <!-- No Action Buttons Section Here -->
                            </div>
                        </div>
                    </div>
                </div>
